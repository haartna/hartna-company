...
export const categories: Category[] = [
  ...
  },
  {
    ...
    nameAr: "آلات السلاش",
    subcategories: [
      { id: "elmec", name: "ELMEC", nameAr: "إلميك" },
...
export const products: Product[] = [
  ...
  {
    id: "7",
    name: "ELMEC Slush Machine Pro",
    nameAr: "آلة سلاش إلميك برو",
    description: "Professional ELMEC slush machine with 3 tanks",
    descriptionAr: "آلة سلاش إلميك احترافية مع 3 خزانات",
    price: 3499,
    image: "/slush-machine.jpg",
  ...
  {
    id: "8",
    name: "SPM Slush Maker",
    nameAr: "صانعة سلاش إس بي إم",
    description: "High-capacity SPM slush machine for commercial use",
    descriptionAr: "آلة سلاش إس بي إم عالية السعة للاستخدام التجاري",
    price: 2899,
    image: "/commercial-slush-machine.jpg",
    category: "slush-machines",
    subcategory: "spm",
    featured: false,
    productOrigin: "France",
    productOriginAr: "فرنسا",
  },
  {
    id: "9",
